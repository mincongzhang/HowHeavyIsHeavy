...
#and generate five audios that have bass value 0.1 0.3 0.5 0.7 0.9 respectively as reference audios

import random
import os,sys

renderpat="E:/Zhang-Mincong"
newpat="E:/Zhang-Mincong/JND_unlabelled_reference_audios/subject1/B"
render="xxx.wav"

data_path="E:/Zhang-Mincong/JND_unlabelled_reference_audios/subject1/data/"
data_filename="Bdata.txt"
...
#reset drive, mid, treble (position: 3 5 6) to some value 
...
#RPR_ShowConsoleMsg("bass:"+str(val4)[:4] +"\n")
...
#bass 0.1 0.3 0.5 0.7 0.9
for i in range(1,6): 
 RPR_TrackFX_SetParam(tr2, 0, 4, (i*0.2-0.1))
 tr3 = RPR_GetTrack(0,0)
 new="B"+str(namelist[i-1])+".wav"
 render_and_rename(renderpat,newpat,render,new)
 bass_val = RPR_TrackFX_GetParam(tr3, 0, 4, 0, 1)[0]
 data_content=new+" bass value:"+str(bass_val)[:4]+"\n\n"
 print_data(data_path,data_filename,data_content)
