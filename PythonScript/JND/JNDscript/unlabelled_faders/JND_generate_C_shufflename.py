...
#and generate five audios that have mid value 0.1 0.3 0.5 0.7 0.9 respectively as reference audios

import random
import os,sys

renderpat="E:/Zhang-Mincong"
newpat="E:/Zhang-Mincong/JND_unlabelled_reference_audios/subject1/C"
render="xxx.wav"
...
#RPR_ShowConsoleMsg("mid:"+str(val5)[:4] +"\n")
...
for i in range(1,6): 
 RPR_TrackFX_SetParam(tr2, 0, 5, (i*0.2-0.1))
 tr3 = RPR_GetTrack(0,0)
 new="C"+str(namelist[i-1])+".wav"
 render_and_rename(renderpat,newpat,render,new)
 mid_val = RPR_TrackFX_GetParam(tr3, 0, 5, 0, 1)[0]
 data_content=new+" mid value:"+str(mid_val)[:4]+"\n\n"
 print_data(data_path,data_filename,data_content)
