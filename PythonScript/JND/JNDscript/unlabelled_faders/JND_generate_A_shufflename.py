#this function will randomly set 3 parameters(bass,mid,treble)
#and generate five audios that have drive value 0.1 0.3 0.5 0.7 0.9 respectively as reference audios

import random
import os,sys

renderpat="E:/Zhang-Mincong"
newpat="E:/Zhang-Mincong/JND_unlabelled_reference_audios/subject1/A"
render="xxx.wav"

data_path="E:/Zhang-Mincong/JND_unlabelled_reference_audios/subject1/data/"
data_filename="Adata.txt"
...
RPR_ShowConsoleMsg( "randomly setting 3 parameters finished\n" )

tr1 = RPR_GetTrack(0,0)
#reset bass, mid, treble (position: 3 5 6) to some value 
...
#RPR_ShowConsoleMsg("drive:"+str(val3)[:4] +"\n")
...
data_content="treble:"+str(val6)[:4] +"\n"
print_data(data_path,data_filename,data_content)
...
for i in range(1,6): 
 RPR_TrackFX_SetParam(tr2, 0, 3, (i*0.2-0.1))
 tr3 = RPR_GetTrack(0,0)
 new="A"+str(namelist[i-1])+".wav"
 render_and_rename(renderpat,newpat,render,new)
 drive_val = RPR_TrackFX_GetParam(tr3, 0, 3, 0, 1)[0]
 data_content=new+" drive value:"+str(drive_val)[:4]+"\n\n"
 print_data(data_path,data_filename,data_content)
